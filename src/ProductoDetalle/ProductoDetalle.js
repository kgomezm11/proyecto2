                                ...
                                productoInfo ? (
                                    <>
                                        ...
                                        <div className="product-text">
                                            ...
                                            <p><b>Recursos del curso: </b>{
                                                [
                                                    productoInfo.recursos[0].video && "Video",
                                                    productoInfo.recursos[0].audio && "Audio",
                                                    productoInfo.recursos[0].documento && "Documento",
                                                    productoInfo.recursos[0].varios && "Otros"
                                                ].filter(Boolean).join(", ")
                                            }</p>
